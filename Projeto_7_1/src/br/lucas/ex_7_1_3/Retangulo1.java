package br.lucas.ex_7_1_3;

import br.lucas.ex7_2.Ponto2D;
import br.lucas.ex7_2.Retangulo;

public class Retangulo1 {
	private Ponto2D a;
	private Ponto2D b;
	
	public Retangulo1(Ponto2D a, Ponto2D b) {
		super();
	...
	public boolean equals (Object obj) {
		...
		if(getClass() != obj.getClass())
			return false;
		Retangulo1 other = (Retangulo1) obj;
		if(a == null)
			if(other.a != null)
				return false;
